...
/**
 * Created by Steven on 7/19/2017.
 */
...
public class BluetoothService {
    ...
    private synchronized void updateUserInterfaceTitle() {
        mState = getState();
//        Log.d("test", "updateUserInterfaceTitle() " + mNewState + " -> " + mState);
        mNewState = mState;
    ...
    public synchronized void connect(BluetoothDevice device, boolean secure) {
        Log.d("test", "bt service, connect to: " + device);
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        Log.d("test", "bt service, connected, Socket Type:" + socketType);
    ...
    private class AcceptThread extends Thread {
        ...
        public AcceptThread(boolean secure) {
            ...
            try {
                ...
                Log.d("test", "service, accept thread() Socket Type: " + mSocketType + "listen() failed");//, e);
            }
            mmServerSocket = tmp;
            mState = STATE_LISTEN;
        }
        ...
        public void run() {
//            Log.d("test", "service, run(), Socket Type: " + mSocketType +
//                    "BEGIN mAcceptThread" + this);
            ...
            while (mState != STATE_CONNECTED) {
                try {
                    ...
                    Log.d("test", "service, run(), Socket Type: " + mSocketType + "accept() failed");//, e);
                    break;
                }
                        ...
                        switch (mState) {
                            ...
                            case STATE_CONNECTED:
                                ...
                                try {
                                    ...
                                    Log.d("test", "service, run(), Could not close unwanted socket");//, e);
                                }
                                break;
                        }
                    }
...
//            Log.d("test", "END mAcceptThread, socket Type: " + mSocketType);
        ...
        public void cancel() {
//            Log.d("test", "service, cancel(), Socket Type" + mSocketType + "cancel " + this);
            try {
                mmServerSocket.close();
            } catch (IOException e) {
//                Log.d("test", "service, cancel(), Socket Type" + mSocketType + "close() of server failed", e);
            }
        }
    }
