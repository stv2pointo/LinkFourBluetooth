...
public class DeviceListActivity extends Activity {
    ...
    private void doDiscovery() {
        ...
        boolean isDis = mBtAdapter.isDiscovering();
        Log.d("test", "before isDiscovering =  " + String.valueOf(isDis) );
        isDis = mBtAdapter.startDiscovery();
        Log.d("test", "value of mBtAdapter.startDiscovery(): " + String.valueOf(isDis) );
        isDis = mBtAdapter.isDiscovering();
        Log.d("test", "after, isDiscovering = " + String.valueOf(isDis) );
    }
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.d("test", "action found: " + action);
